...
A simple bitmap font for the game [ThousandMazes](https://github.com/massblabla/ThousandMazes).
  
## Licensing
* The scripts are licensed under the MIT License.
* The font itself are license under the SIL Open Font License 1.1.
